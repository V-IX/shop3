	...
	<div class="wrapper">
		...
		<div class="mfrs-list">
			...
			<? $i = 1; foreach($items as $item) { ?>
				<li class="col-sm-6 cols-md-4">
					<a href="<?=base_url(uri(1).'/'.$item['alias']);?>" class="mfrs-item clearfix">
						<div class="img">
				...
				<? if($i%4 == 0) { ?><li class="lg-show-only floater"></li><? } ?>
				<? if($i%3 == 0) { ?><li class="md-show-only floater"></li><? } ?>
