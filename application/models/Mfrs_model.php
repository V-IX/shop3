...
class Mfrs_model extends CI_Model {
	
	protected $_folder = 'mfrs';
	protected $_table = 'shop_mfrs';
	protected $_page = 'mfrs';
	...
	{
		$this->query->select('idItem, title');
		$items = $this->getItems(false, false, 'title|ASC', $params);
